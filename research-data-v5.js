...
const MOTIVATION = {"title": "Collective intelligence, with guarantees", "titleSrc": "motivation_and_plate0.md:3-3", "question": "How can we better orchestrate complex systems with multiple interacting agents and components?", "questionSrc": "motivation_and_plate0.md:9-9", "opening": [{"t": "Everything I work on circles around this one question.", "s": "motivation_and_plate0.md:15-15"}, {"t": "It is a bit of a cliché for a researcher to tell you their question is important. But I'll say it anyway, because I think this one really is! It appears in many of the complex systems and infrastructures we interact with every day. For example:", "s": "motivation_and_plate0.md:17-17"}], "examples": [{"name": "Warehouse robotics", "text": "Hundreds of robots must operate safely and efficiently in the same shared space.", "src": "motivation_and_plate0.md:25-25", "nameSrc": "motivation_and_plate0.md:23-23", "img": "figs/key_figs/warehouse-robot.gif"}, {"name": "Mobility and transit", "text": "Travelers, transit operators, and municipalities all make their own decisions over the same transportation network.", "src": "motivation_and_plate0.md:29-29", "nameSrc": "motivation_and_plate0.md:27-27", "img": "figs/key_figs/mobility-system.png"}, {"name": "Power grids", "text": "Generation, storage, and demand are tightly coupled and constantly changing.", "src": "motivation_and_plate0.md:33-33", "nameSrc": "motivation_and_plate0.md:31-31", "img": "figs/key_figs/power-grid.png"}, {"name": "Multi-agent AI", "text": "AI agents increasingly need to communicate, reason, coordinate, and act together.", "src": "motivation_and_plate0.md:37-37", "nameSrc": "motivation_and_plate0.md:35-35", "img": "figs/key_figs/multi-LLM-agent.png"}], "unites": "These systems look very different on the surface, but underneath they share a common structure: many components interact through a shared environment, each has only a partial view of the system, their decisions affect one another, and they must operate despite imperfect models and hard physical or operational constraints. Across them, three challenges keep reappearing. They are what my research is organized around.", "unitesSrc": "motivation_and_plate0.md:41-41", "challenges": [{"name": "Limited communication and observation", "text": "No agent sees the whole system, and communicating everything to everyone is often impossible. How can we achieve effective system-level behavior using only local information and interaction?", "src": "motivation_and_plate0.md:45-45", "nameSrc": "motivation_and_plate0.md:43-43"}, {"name": "Strategic interaction and misaligned incentives", "text": "When agents pursue their own objectives, individually rational decisions need not produce a desirable collective outcome. How can we design incentives and interactions so that individual behavior leads to better system-level outcomes?", "src": "motivation_and_plate0.md:49-49", "nameSrc": "motivation_and_plate0.md:47-47"}, {"name": "Imperfect models and hard constraints", "text": "Our models of the world are never exact, yet decisions still need to work when those models are wrong. At the same time, some requirements, such as safety and physical feasibility, cannot simply be traded against performance.", "src": "motivation_and_plate0.md:53-53", "nameSrc": "motivation_and_plate0.md:51-51"}]};
...
const METHOD_SRC = "motivation_and_plate0.md:59-59";
const OVERVIEW = {"heading": "Overview & Roadmap", "headingSrc": "motivation_and_plate0.md:66-66", "intro": "My research is organized around three recurring challenges in complex multi-agent systems, with each motivating a major research direction:", "introSrc": "motivation_and_plate0.md:68-68", "map": [{"challenge": "Limited communication and observation", "direction": "Control and Learning for Networked Systems", "challengeSrc": "motivation_and_plate0.md:70-70", "directionSrc": "motivation_and_plate0.md:71-71"}, {"challenge": "Strategic interaction and misaligned incentives", "direction": "Multi-Agent Learning through a Game-Theoretic Lens", "challengeSrc": "motivation_and_plate0.md:73-73", "directionSrc": "motivation_and_plate0.md:74-74"}, {"challenge": "Imperfect models and hard constraints", "direction": "Robust and Feasible Decision-Making under Uncertainty", "challengeSrc": "motivation_and_plate0.md:76-76", "directionSrc": "motivation_and_plate0.md:77-77"}], "boxes": [{"name": "Control and Learning for Networked Systems", "text": "Many complex systems are naturally embedded in a network or graph structure. My research asks how we can leverage this structure to design control and learning algorithms that are more scalable, communication-efficient, and data-efficient.", "src": "motivation_and_plate0.md:83-83"}, {"name": "Multi-Agent Learning through a Game-Theoretic Lens", "text": "In complex multi-agent systems, agents may have different incentives. My research studies how agents can reach efficient equilibria efficiently, and, when multiple equilibria exist, how we can steer learning toward outcomes that are better for the system as a whole.", "src": "motivation_and_plate0.md:87-87"}, {"name": "Robust and Feasible Decision-Making under Uncertainty", "text": "Our decisions need to remain reliable despite modeling errors and uncertainty, while also satisfying operational, feasibility, and safety constraints. These requirements become especially challenging in data-driven settings. My research aims to incorporate them into learning and decision-making in a principled way, with theoretical guarantees.", "src": "motivation_and_plate0.md:91-91"}]};
...
(function () {
  ...
  const DIRSRC = ["motivation_and_plate0.md:71-71", "motivation_and_plate0.md:74-74", "motivation_and_plate0.md:77-77"];
...
(function () {
  const SRCS = [{"name": "Control and Learning for Networked Systems", "problemHtml": "<p data-src=\"plate1.md:3-3\"><strong>Problem:</strong> Large networked systems are globally coupled, while sensing, communication, and computation are inherently local. In practice, no agent has access to the entire system, and fully centralized solutions quickly become difficult to implement or learn as the network grows. This tension between <strong>global performance and local information</strong> is where much of my work in networked control and learning begins.</p><p data-src=\"plate1.md:5-5\">When information is inherently local, a natural approach is distributed control, where each agent makes decisions using only the information available within its local neighborhood.</p>", "steps": [{"q": "When can distributed control be nearly as good as centralized control?", "kind": null, "qSrc": "plate1.md:7-7", "brief": "Under the right system structure, locality is already present in the globally optimal solution.", "briefSrc": "plate1.md:15-15", "remainsSrc": "plate1.md:17-17", "html": "<p data-src=\"plate1.md:9-9\">Distributed control has a long history, however, much of the literature focuses on finding the best controller within a prescribed distributed class. But a more fundamental question has received comparatively less attention: <strong>how much performance do we lose relative to the globally optimal centralized controller?</strong></p><p data-src=\"plate1.md:11-11\"><strong>Finding:</strong> In <a href=\"https://arxiv.org/abs/2209.14376\" target=\"_blank\"><em>On the Optimal Control of Network LQR with Spatially-Exponential Decaying Structure</em></a>, we show that when the underlying networked dynamics exhibit suitable spatial decay, the globally optimal LQR controller itself inherits an approximately spatially decaying structure. As a result, it can be well approximated by a localized controller, with a rigorous bound on the resulting performance loss.</p><figure class=\"pfig\" data-fig=\"sed_lqr_spatial_decay.png\" data-src=\"plate1.md:13-13\"><img src=\"figs/key_figs/sed_lqr_spatial_decay.png\" alt=\"\" data-cap=\"\" data-fig=\"sed_lqr_spatial_decay.png\"></figure><p data-src=\"plate1.md:16-16\">What I find most interesting about this result is that locality is not merely a restriction we impose to make control implementable. <strong>Under the right system structure, locality is already present in the globally optimal solution.</strong></p>", "remains": "If the optimal solution itself has approximate locality, can we exploit this structure not only for decentralized control, but also to make learning more scalable?", "figs": []}, {"q": "Can locality be exploited to make learning and control scalable?", "kind": null, "qSrc": "plate1.md:22-22", "brief": "Use this decay structure to build local representations and learning algorithms whose complexity depends primarily on local interactions rather than the full network size.", "briefSrc": "plate1.md:25-25", "remainsSrc": "plate1.md:35-35", "html": "<p data-src=\"plate1.md:24-24\">Building on our work from the previous section, once we know that the influence of distant parts of the network decays, it provides the potential just learn something local that already captures what matters instead of trying to learn a fully global one.</p><p data-src=\"plate1.md:26-26\"><strong>Approach:</strong> Use this decay structure to build local representations and learning algorithms whose complexity depends primarily on local interactions rather than the full network size.</p><p data-src=\"plate1.md:28-28\">This idea leads to several related works:</p><ul data-src=\"plate1.md:30-30\"><li><a href=\"https://arxiv.org/abs/2401.16183\" target=\"_blank\"><em>Scalable Reinforcement Learning for Linear-Quadratic Control of Networks</em></a> shows that locality also propagates to individual value and Q-functions, and develops a local actor-critic algorithm for learning distributed controllers.</li></ul><ul data-src=\"plate1.md:32-32\"><li><a href=\"https://arxiv.org/abs/2410.17221\" target=\"_blank\"><em>Scalable Spectral Representations for Multi-Agent Reinforcement Learning in Network MDPs</em></a> further extend our results to the more complex setting with nonlinear dynamics, where it uses exponential decay in network dynamics to construct local spectral representations of Q-functions, leading to scalable learning for continuous-state/action network MDPs with end-to-end guarantees.</li></ul><ul data-src=\"plate1.md:34-34\"><li><a href=\"https://arxiv.org/abs/1912.09135\" target=\"_blank\"><em>Distributed Reinforcement Learning for Decentralized Linear Quadratic Control: A Derivative-Free Policy Optimization Approach</em></a> approaches the same challenge from a complementary direction, learning local controllers through decentralized zeroth-order policy optimization and consensus using only local information.</li></ul>", "remains": "Spatial decay is only one form of useful structure. Real networked systems often contain other kinds of sparsity, communication structure, factorization, temporal structure, or physical structure. Can those also be turned into algorithmic efficiency?", "figs": []}, {"q": "What other structures can be translated into algorithmic efficiency?", "kind": "application", "qSrc": "plate1.md:40-40", "brief": "identify useful structure in the system, then turn it into algorithmic efficiency.", "briefSrc": "plate1.md:65-65", "remainsSrc": null, "html": "<p data-src=\"plate1.md:42-42\">Spatial locality is only one example. Across different applications, I have explored how other forms of structure can similarly guide algorithm design.</p><p data-src=\"plate1.md:44-44\"><strong>Graph structure → exploration and coverage.</strong></p><div class=\"pfigpair\"><figure class=\"pfig\" data-fig=\"graph-bandit.gif\" data-src=\"plate1.md:46-46\"><img src=\"figs/key_figs/graph-bandit.gif\" alt=\"\" data-cap=\"\" data-fig=\"graph-bandit.gif\"></figure><figure class=\"pfig\" data-fig=\"coverage-control.gif\" data-src=\"plate1.md:47-47\"><img src=\"figs/key_figs/coverage-control.gif\" alt=\"\" data-cap=\"\" data-fig=\"coverage-control.gif\"></figure></div><p data-src=\"plate1.md:49-49\">In <a href=\"https://arxiv.org/abs/2401.10383\" target=\"_blank\"><em>Cooperative Multi-Agent Graph Bandits</em></a>, we exploit communication and mobility structure to design cooperative exploration algorithms whose performance reflects the underlying graph. In <a href=\"https://arxiv.org/abs/2404.05995\" target=\"_blank\"><em>Multi-Agent Coverage Control with Transient Behavior Consideration</em></a>, we further account for how agents physically move through the environment while learning, rather than optimizing only their eventual coverage configuration.</p><p data-src=\"plate1.md:51-51\"><strong>Factorization + temporal structure → scalable multi-agent path finding.</strong></p><div class=\"pfigpair\"><figure class=\"pfig\" data-fig=\"fico_grouping.png\" data-src=\"plate1.md:53-53\"><img src=\"figs/key_figs/fico_grouping.png\" alt=\"\" data-cap=\"\" data-fig=\"fico_grouping.png\"></figure><figure class=\"pfig\" data-fig=\"fico-result.gif\" data-src=\"plate1.md:54-54\"><img src=\"figs/key_figs/fico-result.gif\" alt=\"\" data-cap=\"\" data-fig=\"fico-result.gif\"></figure></div><p data-src=\"plate1.md:56-56\">My recent MAPF work exploits problem factorization and adaptive planning horizons to coordinate large robot fleets in closed loop: <a href=\"https://arxiv.org/abs/2511.13961\" target=\"_blank\">FICO</a>, <a href=\"https://arxiv.org/abs/2602.12024\" target=\"_blank\">Adaptive-Horizon CBS</a>, and <a href=\"https://arxiv.org/abs/2604.00428\" target=\"_blank\">Certificate-Driven MAPF</a>.</p><p data-src=\"plate1.md:58-59\"><strong>Multiple timescales → building control.</strong><br>In our work on <a href=\"https://www.sciencedirect.com/science/article/pii/S0360132323005462\" target=\"_blank\">natural-ventilation control</a>, we combine learned dynamics at multiple timescales, online adaptation, and MPC for energy-efficient building operation.</p><p data-src=\"plate1.md:61-62\"><strong>Network structure → power-grid topology control (ongoing).</strong><br>I am exploring how grid topology and local interactions can determine what information agents need for scalable multi-agent learning and control.</p><p data-src=\"plate1.md:64-64\">Across these applications, the recurring idea is simple:</p><p data-src=\"plate1.md:66-66\"><strong>identify useful structure in the system, then turn it into algorithmic efficiency.</strong></p>", "remains": null, "figs": []}]}, {"name": "Multi-Agent Learning through a Game-Theoretic Lens", "problemHtml": "<p data-src=\"plate2.md:3-3\"><strong>Problem:</strong> Multiple agents learn and make decisions independently, often with different or even competing objectives, while their policies interact through a shared environment. As a result, individually rational behavior does not necessarily lead to a desirable collective outcome. The challenge is therefore not only whether decentralized learning converges, but <strong>what it converges to, how good the resulting equilibrium is, and how learning can be steered toward better coordinated outcomes.</strong></p>", "steps": [{"q": "What do decentralized MARL algorithms actually converge to?", "kind": null, "qSrc": "plate2.md:5-5", "brief": "In Gradient Play in Stochastic Games: Stationary Points, Convergence, and Sample Complexity, we show that, under direct policy parameterization, first-order stationary policies and Nash equilibria are equivalent.", "briefSrc": "plate2.md:8-8", "remainsSrc": "plate2.md:21-21", "html": "<p data-src=\"plate2.md:7-7\">There is already a rich theory of convergence in MARL, but much of it stops at showing convergence to first-order stationary points. So my starting question was: <strong>what do these stationary points actually represent?</strong></p><p data-src=\"plate2.md:9-9\"><strong>Finding:</strong> In <a href=\"https://arxiv.org/abs/2106.00198\" target=\"_blank\"><em>Gradient Play in Stochastic Games: Stationary Points, Convergence, and Sample Complexity</em></a>, we show that, under direct policy parameterization, first-order stationary policies and Nash equilibria are equivalent.</p><figure class=\"pfig\" data-fig=\"stationary_point_NE_equivalence.png\" data-src=\"plate2.md:11-11\"><img src=\"figs/key_figs/stationary_point_NE_equivalence.png\" alt=\"\" data-cap=\"\" data-fig=\"stationary_point_NE_equivalence.png\"></figure><p data-src=\"plate2.md:14-14\">This was the starting point for me to realize that game-theoretic concepts arise naturally in MARL. Once multiple agents independently optimize decentralized policies while interacting through a shared environment, Nash equilibrium becomes a natural solution concept, even when the underlying problem is cooperative.</p><p data-src=\"plate2.md:16-16\">From there, we studied how this picture changes under different policy parameterizations and game structures. For example:</p><ul data-src=\"plate2.md:18-18\"><li><a href=\"https://arxiv.org/abs/2202.00872\" target=\"_blank\"><em>On the Global Convergence Rates of Decentralized Softmax Gradient Play in Markov Potential Games</em></a> studies the more subtle softmax parameterization, where zero-gradient policies need not be Nash equilibria, and establishes finite-time convergence guarantees for decentralized gradient and natural-gradient play.</li></ul><ul data-src=\"plate2.md:20-20\"><li><a href=\"https://arxiv.org/abs/2206.02640\" target=\"_blank\"><em>Policy Optimization for Markov Games: Unified Framework and Faster Convergence</em></a> develops a broader framework for policy optimization in Markov games, with faster convergence guarantees for zero-sum games and extensions to general-sum games.</li></ul>", "remains": "Convergence to a Nash equilibrium does not by itself imply good system-level performance. There can be many equilibria, and their quality can differ substantially.", "figs": []}, {"q": "How good or bad can an equilibrium be?", "kind": null, "qSrc": "plate2.md:26-26", "brief": "In Markov Games with Decoupled Dynamics: Price of Anarchy and Sample Complexity, we extend the price-of-anarchy perspective to finite-horizon Markov games with decoupled dynamics and coupled rewards, providing a rigorous characterization of the worst-case quality of decentralized equilibria.", "briefSrc": "plate2.md:32-32", "remainsSrc": "plate2.md:36-36", "html": "<p data-src=\"plate2.md:28-28\">Once equilibrium becomes the relevant solution concept, the next natural question is how its performance compares with the globally desirable outcome.</p><figure class=\"pfig\" data-fig=\"poa_figure.png\" data-src=\"plate2.md:31-31\"><img src=\"figs/key_figs/poa_figure.png\" alt=\"\" data-cap=\"\" data-fig=\"poa_figure.png\"></figure><p data-src=\"plate2.md:33-33\"><strong>Finding:</strong> In <a href=\"https://arxiv.org/abs/2304.03840\" target=\"_blank\"><em>Markov Games with Decoupled Dynamics: Price of Anarchy and Sample Complexity</em></a>, we extend the price-of-anarchy perspective to finite-horizon Markov games with decoupled dynamics and coupled rewards, providing a rigorous characterization of the worst-case quality of decentralized equilibria.</p><p data-src=\"plate2.md:35-35\">This turns a convergence result into a performance question: even if decentralized learning converges, what can we actually guarantee about the resulting system-level performance?</p>", "remains": "Price of anarchy tells us how bad an equilibrium can be, but it does not tell us how to avoid undesirable equilibria or systematically reach better ones.", "figs": []}, {"q": "Can we systematically reach better equilibria?", "kind": null, "qSrc": "plate2.md:41-41", "brief": "In Equilibrium Selection for Multi-agent Reinforcement Learning: A Unified Framework, we borrow ideas from equilibrium selection in static normal-form games, especially stochastic stability, and develop a framework for transferring these equilibrium-selection mechanisms to stochastic games.", "briefSrc": "plate2.md:44-44", "remainsSrc": "plate2.md:48-48", "html": "<p data-src=\"plate2.md:43-43\">This led to my work on <strong>equilibrium selection</strong>.</p><p data-src=\"plate2.md:45-45\"><strong>Approach:</strong> In <a href=\"https://arxiv.org/abs/2406.08844\" target=\"_blank\"><em>Equilibrium Selection for Multi-agent Reinforcement Learning: A Unified Framework</em></a>, we borrow ideas from equilibrium selection in static normal-form games, especially stochastic stability, and develop a framework for transferring these equilibrium-selection mechanisms to stochastic games.</p><p data-src=\"plate2.md:47-47\">The goal is to move beyond simply proving convergence and instead understand how learning dynamics can favor equilibria with desirable properties.</p>", "remains": "The framework gives a principled theoretical mechanism for equilibrium selection, but the resulting selection dynamics can be slow in practice. More broadly, we would like more direct and efficient ways to discover desirable coordinated behaviors rather than relying on slow asymptotic selection.", "figs": []}, {"q": "Can we discover and select good coordinated behaviors more efficiently?", "kind": null, "qSrc": "plate2.md:53-53", "brief": "", "briefSrc": null, "remainsSrc": null, "html": "<p data-src=\"plate2.md:55-55\">This motivates my more recent work on algorithmic mechanisms that shape the behaviors discovered during learning.</p><ul data-src=\"plate2.md:57-57\"><li><strong>Optimism / risk-seeking:</strong> In <a href=\"https://arxiv.org/abs/2509.24047\" target=\"_blank\"><em>Optimism as Risk-Seeking in Multi-Agent Reinforcement Learning</em></a>, we interpret optimism through risk-seeking objectives and develop decentralized optimistic actor-critic algorithms. The idea is that optimism can encourage agents to explore coordinated outcomes that risk-neutral learning may fail to reach.</li></ul><ul data-src=\"plate2.md:59-59\"><li><strong>Diversity (ongoing):</strong> Can we deliberately discover and maintain qualitatively different coordinated behaviors / equilibria instead of collapsing to one solution?</li></ul><ul data-src=\"plate2.md:61-61\"><li><strong>Signaling and coordination (ongoing):</strong> Can additional coordination signals help agents select among these behaviors or coordinate with other agents more effectively?</li></ul><p data-src=\"plate2.md:63-63\">So the question has gradually evolved from <strong>“Does MARL converge?”</strong> to <strong>“Can MARL efficiently discover and select high-quality coordinated behaviors?”</strong></p>", "remains": null, "figs": []}, {"q": "Transportation Operations and System Design", "kind": "application", "qSrc": "plate2.md:65-65", "brief": "", "briefSrc": null, "remainsSrc": null, "html": "<p data-src=\"plate2.md:67-67\">Transportation systems provide a natural setting for these questions because different regions, operators, and mobility services make their own decisions while sharing infrastructure, users, and congestion.</p><p data-src=\"plate2.md:69-69\">In <a href=\"https://arxiv.org/abs/2508.12059\" target=\"_blank\"><em>Co-Investment with Payoff-Sharing Mechanism for Cooperative Decision-Making in Network Design Games</em></a>, we study strategic interactions among interconnected network operators. The framework combines a non-cooperative network-design game with cooperative mechanisms for <strong>co-investment and payoff sharing</strong>, asking when independently operated subnetworks can find mutually beneficial opportunities to cooperate while preserving their individual incentives.</p><figure class=\"pfig\" data-fig=\"coinv_framework.png\" data-src=\"plate2.md:71-71\"><img src=\"figs/key_figs/coinv_framework.png\" alt=\"\" data-cap=\"\" data-fig=\"coinv_framework.png\"></figure><p data-src=\"plate2.md:74-74\">A related but different question is how to induce a desired system-level outcome when operators remain strategic. In <a href=\"https://arxiv.org/abs/2605.18687\" target=\"_blank\"><em>Implementation-Based Incentive Design for Autonomous Mobility-on-Demand and Transit Systems</em></a>, we take an implementation perspective: rather than searching for a policy and then predicting which equilibrium it induces, we start from a desirable target operating profile and ask <strong>what incentive is needed to make unilateral deviations unattractive</strong>. This leads to an implementation-based framework for coordinating strategic AMoD and public-transit operators under endogenous passenger choices.</p><figure class=\"pfig\" data-fig=\"amod_framework.png\" data-src=\"plate2.md:76-76\"><img src=\"figs/key_figs/amod_framework.png\" alt=\"\" data-cap=\"\" data-fig=\"amod_framework.png\"></figure>", "remains": null, "figs": []}]}, {"name": "Robust and Feasible Decision-Making under Uncertainty", "problemHtml": "<p data-src=\"plate3.md:3-3\"><strong>Problem:</strong> Real systems must make decisions with imperfect models and incomplete knowledge of the environment, while also satisfying physical, operational, and safety constraints. Model errors can make an otherwise good decision unreliable, and some requirements cannot simply be traded against performance. The challenge is therefore twofold: <strong>how do we remain robust when our model is wrong, and how do we preserve feasibility when constraints must be satisfied?</strong></p>", "steps": [{"q": "How should we make decisions when the model is uncertain?", "kind": null, "qSrc": "plate3.md:5-5", "brief": "In Soft Robust MDPs and Risk-Sensitive MDPs: Equivalence, Policy Gradient, and Sample Complexity, we establish an equivalence between a class of soft robust MDPs and risk-sensitive MDPs.", "briefSrc": "plate3.md:8-8", "remainsSrc": "plate3.md:10-10", "html": "<p data-src=\"plate3.md:7-7\">My starting point was <strong>robust decision-making</strong>: if we do not fully trust one nominal model of the environment, how should that uncertainty change the way we optimize a policy?</p><p data-src=\"plate3.md:9-9\"><strong>Finding:</strong> In <a href=\"https://arxiv.org/abs/2306.11626\" target=\"_blank\"><em>Soft Robust MDPs and Risk-Sensitive MDPs: Equivalence, Policy Gradient, and Sample Complexity</em></a>, we establish an equivalence between a class of soft robust MDPs and risk-sensitive MDPs. This connection provides a new way to understand robustness through risk sensitivity, while also leading to policy-gradient and sample-complexity guarantees.</p>", "remains": "Robustness protects performance against model uncertainty. But many physical systems also impose requirements that cannot simply be traded against performance: dynamics must hold, safety limits must be respected, and trajectories must remain feasible.", "figs": []}, {"q": "How do we optimize performance while preserving feasibility?", "kind": null, "qSrc": "plate3.md:15-15", "brief": "", "briefSrc": null, "remainsSrc": "plate3.md:33-33", "html": "<p data-src=\"plate3.md:17-17\">The answer depends on <strong>what access we have to the feasible set</strong>.</p><figure class=\"pfig\" data-fig=\"FOFL.png\" data-src=\"plate3.md:19-19\"><img src=\"figs/key_figs/FOFL.png\" alt=\"\" data-cap=\"\" data-fig=\"FOFL.png\"></figure><p data-src=\"plate3.md:21-22\"><strong>Differentiable constraints → feedback-based constrained optimization.</strong><br>When constraints are explicitly known and differentiable, we can directly use their geometry. In <a href=\"https://arxiv.org/abs/2503.12665\" target=\"_blank\"><em>Constrained Optimization From a Control Perspective via Feedback Linearization</em></a>, we treat constraint violation as a dynamical quantity and design the optimization update to actively drive it toward zero. This yields convergence guarantees to KKT points and connects naturally to classical constrained optimization methods.</p><p data-src=\"plate3.md:25-25\">The same perspective extends to learning problems, including <a href=\"https://arxiv.org/abs/2605.08408\" target=\"_blank\"><em>AdamFLIP</em></a> for hard-constrained PINN training.</p><figure class=\"pfig\" data-fig=\"ZOFL.png\" data-src=\"plate3.md:27-27\"><img src=\"figs/key_figs/ZOFL.png\" alt=\"\" data-cap=\"\" data-fig=\"ZOFL.png\"></figure><p data-src=\"plate3.md:29-30\"><strong>Black-box constraints → zeroth-order constrained optimization.</strong><br>Sometimes we can evaluate a constraint but cannot differentiate it. My zeroth-order work asks how much of the same feasibility structure can still be recovered from function evaluations alone.</p><p data-src=\"plate3.md:32-32\"><a href=\"https://arxiv.org/abs/2509.24056\" target=\"_blank\"><em>Zeroth-Order Constrained Optimization via Feedback Linearization</em></a> extends the feedback-based approach to black-box constraints, while <a href=\"https://arxiv.org/abs/2604.02202\" target=\"_blank\"><em>Random-Subspace SQP</em></a> reduces evaluation cost by solving constrained updates in randomly sampled low-dimensional subspaces.</p>", "remains": "Both settings still assume that feasibility is explicitly defined. But in increasingly data-driven systems, we may only have examples of feasible behavior, with no constraint equation available at all.", "figs": []}, {"q": "How do we optimize when feasibility is represented only through data?", "kind": null, "qSrc": "plate3.md:38-38", "brief": "Our work on <strong>denoising-corrected gradient guidance</strong> views diffusion planning as constrained optimization with an implicitly learned feasible set.", "briefSrc": "plate3.md:48-48", "remainsSrc": null, "html": "<p data-src=\"plate3.md:40-40\">This is the setting I am studying in <strong>diffusion-based planning</strong>.</p><p data-src=\"plate3.md:42-42\">A diffusion model trained on feasible trajectories can generate plausible system behavior, but it does not provide an explicit description of the feasible trajectory set. At test time, we still want to optimize a new task objective without leaving that learned set.</p><figure class=\"pfig\" data-fig=\"gradient-guidance.png\" data-src=\"plate3.md:44-44\"><img src=\"figs/key_figs/gradient-guidance.png\" alt=\"\" data-cap=\"\" data-fig=\"gradient-guidance.png\"></figure><p data-src=\"plate3.md:46-46\">The challenge is that standard gradient guidance acts in the ambient trajectory space, so improving the task objective can simultaneously push the trajectory away from dynamically feasible behavior.</p><p data-src=\"plate3.md:49-49\"><strong>Approach:</strong> Our work on <strong>denoising-corrected gradient guidance</strong> views diffusion planning as constrained optimization with an implicitly learned feasible set. The gradient step improves the objective, while denoising acts as an approximate correction back toward feasible behavior.</p><div class=\"pfigpair\"><figure class=\"pfig\" data-fig=\"DCG-result.jpg\" data-src=\"plate3.md:51-51\"><img src=\"figs/key_figs/DCG-result.jpg\" alt=\"\" data-cap=\"\" data-fig=\"DCG-result.jpg\"></figure><figure class=\"pfig\" data-fig=\"DCG-result-2.jpg\" data-src=\"plate3.md:52-52\"><img src=\"figs/key_figs/DCG-result-2.jpg\" alt=\"\" data-cap=\"\" data-fig=\"DCG-result-2.jpg\"></figure></div><figure class=\"pfig\" data-fig=\"DCG-result-legend.jpg\" data-src=\"plate3.md:54-54\"><img src=\"figs/key_figs/DCG-result-legend.jpg\" alt=\"\" data-cap=\"\" data-fig=\"DCG-result-legend.jpg\"></figure><p data-src=\"plate3.md:56-56\">Across these projects, the progression is really about <strong>how much access we have to feasibility</strong>:</p><p data-src=\"plate3.md:59-61\"><strong>differentiable constraints → gradient access</strong><br><strong>black-box constraints → query access</strong><br><strong>learned feasible behavior → data only</strong></p>", "remains": null, "figs": []}]}];
  SRCS.forEach(SRC => {
...
Object.assign(FUTURE, {"headline": "What I want to build next", "headlineSrc": "plate5.md:3-3", "lead": "A collection of capable agents is not a reliable decision system.", "leadSrc": "plate5.md:9-9", "paras": [{"t": "Put several strong AI systems on one decision and they will duplicate each other's work, agree far too readily, and — the part that actually worries me — confidently produce a plan that violates a constraint nobody thought to write down. Every one of those failure modes is one I have already met somewhere else: agents converging on a poor equilibrium; computation that does not survive scale; an objective improved by quietly breaking feasibility.", "s": "plate5.md:15-15"}, {"t": "So I do not think multi-AI collaboration is a new field. I think it is the question at the top of this page arriving at a new scale, and it is simultaneously a coordination problem, a scale problem, and a feasibility problem. That intersection is precisely where the three themes were built to meet.", "s": "plate5.md:17-17"}], "bets": [{"name": "Reasoning-guided optimization and control", "nameSrc": "plate5.md:23-23", "text": "Let language models propose the decomposition, the objective, the policy class, the solver strategy — and let optimization and control layers refine what is workable and certify what is safe. The proposal and the guarantee come from different places, deliberately, because the thing that is good at generating options is not the thing that should be trusted to approve them.", "src": "plate5.md:25-25"}, {"name": "Interaction design for AI collectives", "nameSrc": "plate5.md:27-27", "text": "Communication and signaling protocols that divide labor, resist premature agreement, and keep a genuinely diverse set of candidate plans alive long enough to be compared. This is equilibrium selection and signaling again, with agents that can talk to each other.", "src": "plate5.md:29-29"}, {"name": "Guarantees that compose", "nameSrc": "plate5.md:31-31", "text": "The one I care about most. Approximation error from a localized policy, feasibility error from a learned correction, coordination loss from imperfect signaling: I want to know how these propagate across an interface, so that a guarantee about a module means something about the whole architecture. Without it, every deployed system is a pile of separately tuned parts and we are guessing.", "src": "plate5.md:33-33"}], "groundLead": "None of this is meant to stay abstract. Each of the systems below forced one of the questions on this page, and each is where the next answer will have to hold up.", "groundLeadSrc": "plate5.md:39-39", "apps": [{"name": "Power grids", "nameSrc": "plate5.md:41-41", "text": "Topology control changes which lines carry power. It can make a grid more resilient, and it silently rewrites what every local controller is allowed to do. Reconfiguration and control cannot be designed separately.", "src": "plate5.md:43-43"}, {"name": "Robot fleets", "nameSrc": "plate5.md:45-45", "text": "Hundreds of robots, a decision every few hundred milliseconds, and a collision is not a worse solution — it is not a solution. Everything here is a race between how far ahead you look and how long you are allowed to think.", "src": "plate5.md:47-47"}, {"name": "Buildings", "nameSrc": "plate5.md:49-49", "text": "Thermal mass moves over hours; occupancy and weather move over minutes. Control that ignores either timescale either wastes energy or makes the room unusable, and the model is always somewhat wrong.", "src": "plate5.md:51-51"}, {"name": "Mobility and transit", "nameSrc": "plate5.md:53-53", "text": "Operators who share riders and roads but not budgets. Nothing gets adopted because it is socially optimal; it gets adopted because deviating from it costs more than going along with it.", "src": "plate5.md:55-55"}], "closing": "That is what the title of this page is meant to commit to, rather than merely assert: I would rather have a system whose limits I can state precisely than one that only performs well in the demo.", "closingSrc": "plate5.md:61-61"});

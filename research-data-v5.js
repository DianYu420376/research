...
Object.assign(FUTURE, {"fig": "figs/key_figs/composability.png", "figCap": "Independently trained agents become a capable team through coordination. Zooming in on one agent: what it receives, how it is trained, and what it sends.", "figCapSrc": "plate5.md:27-27", "headline": "Coordination architectures for composable multi-agent systems", "headlineSrc": "plate5.md:3-3", "lead": "As autonomous agents become more capable, the next bottleneck may not be training one stronger agent, but assembling many independently trained agents into a capable team.", "leadSrc": "plate5.md:9-9", "paras": [{"t": "Today, many multi-agent systems still rely on strong assumptions: agents are trained together, share the same conventions, or adapt to each other only after observing enough behavior. But future systems will likely be much messier. Robots, AI agents, infrastructure controllers, and decision-making modules may be trained by different groups, on different data, with different objectives, interfaces, and hidden conventions. They may need to work together without joint retraining.", "s": "plate5.md:15-15"}, {"t": "There are already rich lines of work on related problems, including zero-shot coordination, ad hoc teamwork, theory of mind, multi-agent communication, and teammate modeling. These works answer important pieces of the puzzle. But I am interested in a broader architectural question: <strong>what should the coordination architecture look like when independently trained agents need to become a team?</strong>", "s": "plate5.md:17-17"}, {"t": "A useful analogy is modular software. A module is not useful only because its internal code is good. It is useful because it has an interface: other modules know what it expects, what it provides, and how to interact with it. Multi-agent systems need something similar, but richer. An agent's interface should also help others understand what it can do, how it tends to behave, what information it needs, and how it can be adjusted. That is why I think coordination should be treated as an <strong>architectural layer</strong>, not merely as an emergent property of self-play or behavior-only adaptation.", "s": "plate5.md:19-19"}], "bets": [], "components": [{"name": "Incoming interface", "nameSrc": "plate5.md:33-33", "summary": "How an agent understands and reacts to what it receives.", "summarySrc": "plate5.md:35-35", "paras": [{"t": "Once useful information is exposed, another agent must be able to use it. It should not simply store context as text or metadata. It should convert that information into decisions: what role to take, what behavior to expect, what operating mode to use, when to communicate, and when to revise its belief.", "s": "plate5.md:37-37"}, {"t": "For example, if another agent tends to take a certain role, has limited sensing, rarely yields at bottlenecks, or was trained on a different task distribution, the receiving agent should know how this changes its own behavior.", "s": "plate5.md:39-39"}, {"t": "This connects naturally to teammate modeling, theory of mind, and ad hoc teamwork, but the goal is broader. The incoming interface should become a reusable mechanism for understanding and reacting to new partners, not just a task-specific adaptation trick.", "s": "plate5.md:41-41"}], "questions": [{"t": "How should an agent convert incoming context into beliefs, roles, plans, or operating modes?", "s": "plate5.md:43-43"}, {"t": "How should agents use those beliefs, roles, plans or operating modes to make decisions?", "s": "plate5.md:44-44"}, {"t": "How should an agent refine its interpretation as it observes more behavior?", "s": "plate5.md:45-45"}]}, {"name": "Train for composability", "nameSrc": "plate5.md:47-47", "summary": "How to train agents to coordinate, communicate, and adapt.", "summarySrc": "plate5.md:49-49", "paras": [{"t": "The outgoing and incoming interfaces should not be treated as afterthoughts added after training. If agents will later be assembled into new teams, they should be trained not only to perform well, but also to be understandable, adaptable, and useful to others. This means agents should learn how to expose useful information, interpret incoming information, and adjust their behavior when coordination changes.", "s": "plate5.md:51-51"}, {"t": "This is the part that makes the vision more than a protocol design problem. A useful coordination architecture cannot only be written down after training. It should influence the training process itself.", "s": "plate5.md:53-53"}], "questions": [{"t": "How do we train agents whose behavior is legible to new partners?", "s": "plate5.md:55-55"}, {"t": "How do we train agents to communicate the right information at the right level of abstraction?", "s": "plate5.md:56-56"}, {"t": "How do we train agents to deliberately use incoming context rather than ignore it?", "s": "plate5.md:57-57"}, {"t": "How do we train adaptable operating modes, so that an agent can be steered without full retraining?", "s": "plate5.md:58-58"}, {"t": "How do we evaluate whether an agent is composable, not just high-performing?", "s": "plate5.md:59-59"}]}, {"name": "Outgoing interface", "nameSrc": "plate5.md:61-61", "summary": "What useful information an agent should report about itself.", "summarySrc": "plate5.md:63-63", "paras": [{"t": "An agent may need to report information about its training background, behavioral tendencies, capabilities, uncertainty, current intent, or available operating modes. This information could be encoded in structured fields, natural language, learned embeddings, diagnostic statistics, or a hybrid format. The key is that it should be useful for coordination.", "s": "plate5.md:65-65"}, {"t": "This is related to multi-agent communication, model cards, agent interoperability, and language-grounded coordination. But here the goal is not only communication for one task. The goal is to understand what kind of outgoing interface makes agents easier to compose with others.", "s": "plate5.md:67-67"}], "questions": [{"t": "What should an agent communicate before interaction begins, and what kinds of teammate information are useful for decision-making?", "s": "plate5.md:69-69"}, {"t": "What should it communicate during interaction?", "s": "plate5.md:70-70"}, {"t": "How can it summarize its training history, behavior, capabilities, and limitations in a compact way?", "s": "plate5.md:71-71"}]}], "groundLead": "", "groundLeadSrc": null, "apps": [], "closing": "The long-term goal is a principled architecture for open multi-agent coordination: a way for agents to expose useful information, understand incoming context, adapt through interaction, and be trained for composability from the beginning. Not a rigid hand-coded rulebook, but a structure through which agents make themselves understandable to others, receive and use coordination-relevant information, and adapt as the team and task evolve. This is the kind of multi-agent intelligence I want to build next: agents that do not only perform well alone, but can be <strong>assembled, connected, adapted, and deployed</strong> as robust teams.", "closingSrc": "plate5.md:77-77"});

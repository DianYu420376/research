...
Object.assign(FUTURE, {"fig": "figs/key_figs/composability.png", "figCap": "What an agent exposes, how it interprets what it receives, and how both are refined as interaction unfolds.", "figCapSrc": "plate5.md:27-27", "headline": "Coordination architectures for composable multi-agent systems", "headlineSrc": "plate5.md:3-3", "lead": "A collection of capable agents is not a reliable team.", "leadSrc": "plate5.md:9-9", "paras": [{"t": "The next generation of multi-agent systems will not always be trained as one fixed team. They will be assembled from agents built by different groups, on different data, with different conventions, capabilities, and degrees of controllability. As individual agents get stronger and more specialized, the bottleneck stops being how to train a better policy. It becomes how to <strong>compose independently trained agents into a team that actually works.</strong>", "s": "plate5.md:15-15"}, {"t": "Three things make that hard. Joint training does not survive open teams: self-play produces strong conventions inside one training population, and future teammates were never in it. Cold-start coordination is expensive, because behavior-only adaptation needs interaction evidence, and in robotics, traffic, or grids the early mistakes are exactly the ones you cannot afford. And communication alone is not enough — free-form messages are often ambiguous, uncalibrated, or disconnected from control.", "s": "plate5.md:17-17"}, {"t": "So I think coordination should be treated as an <strong>architectural</strong> problem, not only a learning one. An agent should enter interaction already able to say something useful about itself, interpret what it receives, expose modes others can steer, and refine all of it as evidence accumulates. That is a coordination problem, a scale problem and a feasibility problem at once, which is where the three themes on this page were built to meet.", "s": "plate5.md:19-19"}], "bets": [{"name": "Training for composability", "nameSrc": "plate5.md:33-33", "text": "Train agents to be composed, not only to perform. That means experiencing diverse partners, tasks and interaction patterns during training; learning what is worth exposing to others; learning how incoming messages should move beliefs and decisions; and generalizing to partners never seen jointly, without retraining the team.", "src": "plate5.md:35-35"}, {"name": "The context an agent carries", "nameSrc": "plate5.md:37-37", "text": "Before interaction begins, an agent should be able to describe itself in a way others can act on: how it was trained, how it tends to behave, what it can do and at what cost, and which operating modes it will accept. Structured fields, natural language or a learned embedding all work — what matters is that the description is grounded in behavior, so a teammate can use it to choose roles, predict, and steer.", "src": "plate5.md:39-39"}, {"name": "Coordinating before the evidence arrives", "nameSrc": "plate5.md:41-41", "text": "Identifying a teammate from behavior alone takes interaction, and the first few decisions are often the costly ones. The question is how agents, and a coordinator when one exists, should act on initial context when almost nothing has been observed yet — and how the system recovers when that context turns out to be noisy, stale, or simply wrong.", "src": "plate5.md:43-43"}, {"name": "Guarantees that compose", "nameSrc": "plate5.md:45-45", "text": "The one I care about most, and the reason the rest is not just engineering. Approximation error from a localized policy, feasibility error from a learned correction, coordination loss from imperfect signaling: I want to know how these propagate across an interface, so that a guarantee about one agent means something about the assembled team. Without it, every deployed system is a pile of separately tuned parts and we are guessing.", "src": "plate5.md:47-47"}], "groundLead": "None of this is meant to stay abstract. Each of the systems below forced one of the questions on this page, and each is where the next answer will have to hold up.", "groundLeadSrc": "plate5.md:53-53", "apps": [{"name": "Power grids", "nameSrc": "plate5.md:55-55", "text": "Topology control changes which lines carry power. It can make a grid more resilient, and it silently rewrites what every local controller is allowed to do. Reconfiguration and control cannot be designed separately.", "src": "plate5.md:57-57"}, {"name": "Robot fleets", "nameSrc": "plate5.md:59-59", "text": "Hundreds of robots, a decision every few hundred milliseconds, and a collision is not a worse solution — it is not a solution. Everything here is a race between how far ahead you look and how long you are allowed to think.", "src": "plate5.md:61-61"}, {"name": "Buildings", "nameSrc": "plate5.md:63-63", "text": "Thermal mass moves over hours; occupancy and weather move over minutes. Control that ignores either timescale either wastes energy or makes the room unusable, and the model is always somewhat wrong.", "src": "plate5.md:65-65"}, {"name": "Mobility and transit", "nameSrc": "plate5.md:67-67", "text": "Operators who share riders and roads but not budgets. Nothing gets adopted because it is socially optimal; it gets adopted because deviating from it costs more than going along with it.", "src": "plate5.md:69-69"}], "closing": "That is what the title of this page is meant to commit to, rather than merely assert: I would rather have a system whose limits I can state precisely than one that only performs well in the demo.", "closingSrc": "plate5.md:75-75"});

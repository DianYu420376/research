...
(function () {
  const SRCS = [{"name": "Control and Learning for Networked Systems", "problemHtml": "<p data-src=\"plate1.md:3-3\"><strong>Problem:</strong> Large networked systems are globally coupled, while sensing, communication, and computation are inherently local. In practice, no agent has access to the entire system, and fully centralized solutions quickly become difficult to implement or learn as the network grows. This tension between <strong>global performance and local information</strong> is where much of my work in networked control and learning begins.</p><p data-src=\"plate1.md:5-5\">When information is inherently local, a natural approach is distributed control, where each agent makes decisions using only the information available within its local neighborhood.</p>", "steps": [{"q": "When can distributed control be nearly as good as centralized control?", "kind": null, "qSrc": "plate1.md:7-7", "brief": "Under the right system structure, locality is already present in the globally optimal solution.", "briefSrc": "plate1.md:9-9", "remainsSrc": "plate1.md:20-20", "html": "<p data-src=\"plate1.md:10-10\">Distributed control has a long history, however, much of the literature focuses on finding the best controller within a prescribed distributed class. But a more fundamental question has received comparatively less attention: <strong>how much performance do we lose relative to the globally optimal centralized controller?</strong></p><p data-src=\"plate1.md:12-12\"><strong>Finding:</strong> In <a href=\"https://arxiv.org/abs/2209.14376\" target=\"_blank\"><em>On the Optimal Control of Network LQR with Spatially-Exponential Decaying Structure</em></a>, we show that when the underlying networked dynamics exhibit suitable spatial decay, the globally optimal LQR controller itself inherits an approximately spatially decaying structure. As a result, it can be well approximated by a localized controller, with a rigorous bound on the resulting performance loss.</p><figure class=\"pfig\" data-fig=\"sed_lqr_spatial_decay.png\" data-src=\"plate1.md:14-14\"><img src=\"figs/key_figs/sed_lqr_spatial_decay.png\" alt=\"\" data-cap=\"\" data-fig=\"sed_lqr_spatial_decay.png\"></figure><p data-src=\"plate1.md:17-17\">What I find most interesting about this result is that locality is not merely a restriction we impose to make control implementable. <strong>Under the right system structure, locality is already present in the globally optimal solution.</strong></p>", "remains": "If the optimal solution itself has approximate locality, can we exploit this structure not only for decentralized control, but also to make learning more scalable?", "figs": []}, {"q": "Can locality be exploited to make learning and control scalable?", "kind": null, "qSrc": "plate1.md:24-24", "brief": "Use this decay structure to build local representations and learning algorithms whose complexity depends primarily on local interactions rather than the full network size.", "briefSrc": "plate1.md:26-26", "remainsSrc": "plate1.md:40-40", "html": "<p data-src=\"plate1.md:27-27\">Building on our work from the previous section, once we know that the influence of distant parts of the network decays, it provides the potential just learn local policies that already captures what matters instead of trying to learn a fully global one.</p><p data-src=\"plate1.md:29-29\"><strong>Approach:</strong> Use this decay structure to build local representations and learning algorithms whose complexity depends primarily on local interactions rather than the full network size.</p><p data-src=\"plate1.md:31-31\">This idea leads to several related works:</p><ul data-src=\"plate1.md:33-33\"><li><a href=\"https://arxiv.org/abs/2401.16183\" target=\"_blank\"><em>Scalable Reinforcement Learning for Linear-Quadratic Control of Networks</em></a> shows that locality also propagates to individual value and Q-functions, and develops a local actor-critic algorithm for learning distributed controllers.</li></ul><ul data-src=\"plate1.md:35-35\"><li><a href=\"https://arxiv.org/abs/2410.17221\" target=\"_blank\"><em>Scalable Spectral Representations for Multi-Agent Reinforcement Learning in Network MDPs</em></a> further extend our results to the more complex setting with nonlinear dynamics, where it uses exponential decay in network dynamics to construct local spectral representations of Q-functions, leading to scalable learning for continuous-state/action network MDPs with end-to-end guarantees.</li></ul><ul data-src=\"plate1.md:37-37\"><li><a href=\"https://arxiv.org/abs/1912.09135\" target=\"_blank\"><em>Distributed Reinforcement Learning for Decentralized Linear Quadratic Control: A Derivative-Free Policy Optimization Approach</em></a> approaches the same challenge from a complementary direction, learning local controllers through decentralized zeroth-order policy optimization and consensus using only local information.</li></ul>", "remains": "Spatial decay is only one form of useful structure. Real networked systems often contain other kinds of sparsity, communication structure, factorization, temporal structure, or physical structure. Can those also be turned into algorithmic efficiency?", "figs": []}, {"q": "What other structures can be translated into algorithmic efficiency?", "kind": "application", "qSrc": "plate1.md:44-44", "brief": "Identify useful structure in the system, then turn it into algorithmic efficiency.", "briefSrc": "plate1.md:46-46", "remainsSrc": null, "html": "<p data-src=\"plate1.md:47-47\">Spatial locality is only one example. Across different applications, I have explored how other forms of structure can similarly guide algorithm design.</p><p data-src=\"plate1.md:49-49\"><strong>Graph structure → exploration and coverage.</strong></p><div class=\"pfigpair\"><figure class=\"pfig\" data-fig=\"graph-bandit.gif\" data-src=\"plate1.md:51-51\"><img src=\"figs/key_figs/graph-bandit.gif\" alt=\"\" data-cap=\"\" data-fig=\"graph-bandit.gif\"></figure><figure class=\"pfig\" data-fig=\"coverage-control.gif\" data-src=\"plate1.md:52-52\"><img src=\"figs/key_figs/coverage-control.gif\" alt=\"\" data-cap=\"\" data-fig=\"coverage-control.gif\"></figure></div><p data-src=\"plate1.md:54-54\">In <a href=\"https://arxiv.org/abs/2401.10383\" target=\"_blank\"><em>Cooperative Multi-Agent Graph Bandits</em></a>, we exploit communication and mobility structure to design cooperative exploration algorithms whose performance reflects the underlying graph. In <a href=\"https://arxiv.org/abs/2404.05995\" target=\"_blank\"><em>Multi-Agent Coverage Control with Transient Behavior Consideration</em></a>, we further account for how agents physically move through the environment while learning, rather than optimizing only their eventual coverage configuration.</p><p data-src=\"plate1.md:56-56\"><strong>Factorization + temporal structure → scalable multi-agent path finding.</strong></p><div class=\"pfigpair\"><figure class=\"pfig\" data-fig=\"fico_grouping.png\" data-src=\"plate1.md:58-58\"><img src=\"figs/key_figs/fico_grouping.png\" alt=\"\" data-cap=\"\" data-fig=\"fico_grouping.png\"></figure><figure class=\"pfig\" data-fig=\"fico-result.gif\" data-src=\"plate1.md:59-59\"><img src=\"figs/key_figs/fico-result.gif\" alt=\"\" data-cap=\"\" data-fig=\"fico-result.gif\"></figure></div><p data-src=\"plate1.md:61-61\">My recent MAPF work exploits problem factorization and adaptive planning horizons to coordinate large robot fleets in closed loop: <a href=\"https://arxiv.org/abs/2511.13961\" target=\"_blank\">FICO</a>, <a href=\"https://arxiv.org/abs/2602.12024\" target=\"_blank\">Adaptive-Horizon CBS</a>, and <a href=\"https://arxiv.org/abs/2604.00428\" target=\"_blank\">Certificate-Driven MAPF</a>.</p><p data-src=\"plate1.md:63-64\"><strong>Multiple timescales → building control.</strong><br>In our work on <a href=\"https://www.sciencedirect.com/science/article/pii/S0360132323005462\" target=\"_blank\">natural-ventilation control</a>, we combine learned dynamics at multiple timescales, online adaptation, and MPC for energy-efficient building operation.</p><p data-src=\"plate1.md:66-67\"><strong>Network structure → power-grid topology control (ongoing).</strong><br>I am exploring how grid topology and local interactions can determine what information agents need for scalable multi-agent learning and control.</p><p data-src=\"plate1.md:69-69\">Across these applications, the recurring idea is simple:</p><p data-src=\"plate1.md:71-71\"><strong>identify useful structure in the system, then turn it into algorithmic efficiency.</strong></p>", "remains": null, "figs": []}]}, {"name": "Multi-Agent Learning through a Game-Theoretic Lens", "problemHtml": "<p data-src=\"plate2.md:3-3\"><strong>Problem:</strong> Multiple agents learn and make decisions independently, often with different or even competing objectives, while their policies interact through a shared environment. As a result, individually rational behavior does not necessarily lead to a desirable collective outcome. The challenge is therefore not only whether decentralized learning converges, but <strong>what it converges to, how good the resulting equilibrium is, and how learning can be steered toward better coordinated outcomes.</strong></p>", "steps": [{"q": "What do decentralized MARL algorithms actually converge to?", "kind": null, "qSrc": "plate2.md:5-5", "brief": "We show that, under direct policy parameterization, first-order stationary policies and Nash equilibria are equivalent.", "briefSrc": "plate2.md:7-7", "remainsSrc": "plate2.md:24-24", "html": "<p data-src=\"plate2.md:8-8\">There is already a rich theory of convergence in MARL, but much of it stops at showing convergence to first-order stationary points. So my starting question was: <strong>what do these stationary points actually represent?</strong></p><p data-src=\"plate2.md:10-10\"><strong>Finding:</strong> In <a href=\"https://arxiv.org/abs/2106.00198\" target=\"_blank\"><em>Gradient Play in Stochastic Games: Stationary Points, Convergence, and Sample Complexity</em></a>, we show that, under direct policy parameterization, first-order stationary policies and Nash equilibria are equivalent.</p><figure class=\"pfig\" data-fig=\"stationary_point_NE_equivalence.png\" data-src=\"plate2.md:12-12\"><img src=\"figs/key_figs/stationary_point_NE_equivalence.png\" alt=\"\" data-cap=\"\" data-fig=\"stationary_point_NE_equivalence.png\"></figure><p data-src=\"plate2.md:15-15\">This was the starting point for me to realize that game-theoretic concepts arise naturally in MARL. Once multiple agents independently optimize decentralized policies while interacting through a shared environment, Nash equilibrium becomes a natural solution concept, even when the underlying problem is cooperative.</p><p data-src=\"plate2.md:17-17\">From there, we studied how this picture changes under different policy parameterizations and game structures. For example:</p><ul data-src=\"plate2.md:19-19\"><li><a href=\"https://arxiv.org/abs/2202.00872\" target=\"_blank\"><em>On the Global Convergence Rates of Decentralized Softmax Gradient Play in Markov Potential Games</em></a> studies the more subtle softmax parameterization, where zero-gradient policies need not be Nash equilibria, and establishes finite-time convergence guarantees for decentralized gradient and natural-gradient play.</li></ul><ul data-src=\"plate2.md:21-21\"><li><a href=\"https://arxiv.org/abs/2206.02640\" target=\"_blank\"><em>Policy Optimization for Markov Games: Unified Framework and Faster Convergence</em></a> develops a broader framework for policy optimization in Markov games, with faster convergence guarantees for zero-sum games and extensions to general-sum games.</li></ul>", "remains": "Convergence to a Nash equilibrium does not by itself imply good system-level performance. There can be many equilibria, and their quality can differ substantially.", "figs": []}, {"q": "How good or bad can an equilibrium be?", "kind": null, "qSrc": "plate2.md:28-28", "brief": "We extend the price-of-anarchy perspective to finite-horizon Markov games with decoupled dynamics and coupled rewards, providing a rigorous characterization of the worst-case quality of decentralized equilibria.", "briefSrc": "plate2.md:30-30", "remainsSrc": "plate2.md:41-41", "html": "<p data-src=\"plate2.md:31-31\">Once equilibrium becomes the relevant solution concept, the next natural question is how its performance compares with the globally desirable outcome.</p><figure class=\"pfig\" data-fig=\"poa_figure.png\" data-src=\"plate2.md:34-34\"><img src=\"figs/key_figs/poa_figure.png\" alt=\"\" data-cap=\"\" data-fig=\"poa_figure.png\"></figure><p data-src=\"plate2.md:36-36\"><strong>Finding:</strong> In <a href=\"https://arxiv.org/abs/2304.03840\" target=\"_blank\"><em>Markov Games with Decoupled Dynamics: Price of Anarchy and Sample Complexity</em></a>, we extend the price-of-anarchy perspective to finite-horizon Markov games with decoupled dynamics and coupled rewards, providing a rigorous characterization of the worst-case quality of decentralized equilibria.</p><p data-src=\"plate2.md:38-38\">This turns a convergence result into a performance question: even if decentralized learning converges, what can we actually guarantee about the resulting system-level performance?</p>", "remains": "Price of anarchy tells us how bad an equilibrium can be, but it does not tell us how to avoid undesirable equilibria or systematically reach better ones.", "figs": []}, {"q": "Can we systematically reach better equilibria?", "kind": null, "qSrc": "plate2.md:45-45", "brief": "We borrow ideas from equilibrium selection in static normal-form games, especially stochastic stability, and develop a framework for transferring these equilibrium-selection mechanisms to stochastic games.", "briefSrc": "plate2.md:47-47", "remainsSrc": "plate2.md:55-55", "html": "<p data-src=\"plate2.md:48-48\">This led to my work on <strong>equilibrium selection</strong>.</p><p data-src=\"plate2.md:50-50\"><strong>Approach:</strong> In <a href=\"https://arxiv.org/abs/2406.08844\" target=\"_blank\"><em>Equilibrium Selection for Multi-agent Reinforcement Learning: A Unified Framework</em></a>, we borrow ideas from equilibrium selection in static normal-form games, especially stochastic stability, and develop a framework for transferring these equilibrium-selection mechanisms to stochastic games.</p><p data-src=\"plate2.md:52-52\">The goal is to move beyond simply proving convergence and instead understand how learning dynamics can favor equilibria with desirable properties.</p>", "remains": "The framework gives a principled theoretical mechanism for equilibrium selection, but the resulting selection dynamics can be slow in practice. More broadly, we would like more direct and efficient ways to discover desirable coordinated behaviors rather than relying on slow asymptotic selection.", "figs": []}, {"q": "Can we discover and select good coordinated behaviors more efficiently?", "kind": null, "qSrc": "plate2.md:59-59", "brief": "", "briefSrc": null, "remainsSrc": null, "html": "<p data-src=\"plate2.md:61-61\">This motivates my more recent work on algorithmic mechanisms that shape the behaviors discovered during learning.</p><ul data-src=\"plate2.md:63-63\"><li><strong>Optimism / risk-seeking:</strong> In <a href=\"https://arxiv.org/abs/2509.24047\" target=\"_blank\"><em>Optimism as Risk-Seeking in Multi-Agent Reinforcement Learning</em></a>, we interpret optimism through risk-seeking objectives and develop decentralized optimistic actor-critic algorithms. The idea is that optimism can encourage agents to explore coordinated outcomes that risk-neutral learning may fail to reach.</li></ul><ul data-src=\"plate2.md:65-65\"><li><strong>Diversity (ongoing):</strong> Can we deliberately discover and maintain qualitatively different coordinated behaviors / equilibria instead of collapsing to one solution?</li></ul><ul data-src=\"plate2.md:67-67\"><li><strong>Signaling and coordination (ongoing):</strong> Can additional coordination signals help agents select among these behaviors or coordinate with other agents more effectively?</li></ul><p data-src=\"plate2.md:69-69\">So the question has gradually evolved from <strong>“Does MARL converge?”</strong> to <strong>“Can MARL efficiently discover and select high-quality coordinated behaviors?”</strong></p>", "remains": null, "figs": []}, {"q": "Transportation Operations and System Design", "kind": "application", "qSrc": "plate2.md:71-71", "brief": "", "briefSrc": null, "remainsSrc": null, "html": "<p data-src=\"plate2.md:73-73\">Transportation systems provide a natural setting for these questions because different regions, operators, and mobility services make their own decisions while sharing infrastructure, users, and congestion.</p><p data-src=\"plate2.md:75-75\">In <a href=\"https://arxiv.org/abs/2508.12059\" target=\"_blank\"><em>Co-Investment with Payoff-Sharing Mechanism for Cooperative Decision-Making in Network Design Games</em></a>, we study strategic interactions among interconnected network operators. The framework combines a non-cooperative network-design game with cooperative mechanisms for <strong>co-investment and payoff sharing</strong>, asking when independently operated subnetworks can find mutually beneficial opportunities to cooperate while preserving their individual incentives.</p><figure class=\"pfig\" data-fig=\"coinv_framework.png\" data-src=\"plate2.md:77-77\"><img src=\"figs/key_figs/coinv_framework.png\" alt=\"\" data-cap=\"\" data-fig=\"coinv_framework.png\"></figure><p data-src=\"plate2.md:80-80\">A related but different question is how to induce a desired system-level outcome when operators remain strategic. In <a href=\"https://arxiv.org/abs/2605.18687\" target=\"_blank\"><em>Implementation-Based Incentive Design for Autonomous Mobility-on-Demand and Transit Systems</em></a>, we take an implementation perspective: rather than searching for a policy and then predicting which equilibrium it induces, we start from a desirable target operating profile and ask <strong>what incentive is needed to make unilateral deviations unattractive</strong>. This leads to an implementation-based framework for coordinating strategic AMoD and public-transit operators under endogenous passenger choices.</p><figure class=\"pfig\" data-fig=\"amod_framework.png\" data-src=\"plate2.md:82-82\"><img src=\"figs/key_figs/amod_framework.png\" alt=\"\" data-cap=\"\" data-fig=\"amod_framework.png\"></figure>", "remains": null, "figs": []}]}, {"name": "Robust and Feasible Decision-Making under Uncertainty", "problemHtml": "<p data-src=\"plate3.md:3-3\"><strong>Problem:</strong> Real systems must make decisions with imperfect models and incomplete knowledge of the environment, while also satisfying physical, operational, and safety constraints. Model errors can make an otherwise good decision unreliable, and some requirements cannot simply be traded against performance. The challenge is therefore twofold: <strong>how do we remain robust when our model is wrong, and how do we preserve feasibility when constraints must be satisfied?</strong></p>", "steps": [{"q": "How should we make decisions when the model is uncertain?", "kind": null, "qSrc": "plate3.md:5-5", "brief": "We establish an equivalence between a class of soft robust MDPs and risk-sensitive MDPs.", "briefSrc": "plate3.md:7-7", "remainsSrc": "plate3.md:13-13", "html": "<p data-src=\"plate3.md:8-8\">My starting point was <strong>robust decision-making</strong>: if we do not fully trust one nominal model of the environment, how should that uncertainty change the way we optimize a policy?</p><p data-src=\"plate3.md:10-10\"><strong>Finding:</strong> In <a href=\"https://arxiv.org/abs/2306.11626\" target=\"_blank\"><em>Soft Robust MDPs and Risk-Sensitive MDPs: Equivalence, Policy Gradient, and Sample Complexity</em></a>, we establish an equivalence between a class of soft robust MDPs and risk-sensitive MDPs. This connection provides a new way to understand robustness through risk sensitivity, while also leading to policy-gradient and sample-complexity guarantees.</p>", "remains": "Robustness protects performance against model uncertainty. But many physical systems also impose requirements that cannot simply be traded against performance: dynamics must hold, safety limits must be respected, and trajectories must remain feasible.", "figs": []}, {"q": "How do we optimize performance while preserving feasibility?", "kind": null, "qSrc": "plate3.md:17-17", "brief": "", "briefSrc": null, "remainsSrc": "plate3.md:36-36", "html": "<p data-src=\"plate3.md:19-19\">The answer depends on <strong>what access we have to the feasible set</strong>.</p><figure class=\"pfig\" data-fig=\"FOFL.png\" data-src=\"plate3.md:21-21\"><img src=\"figs/key_figs/FOFL.png\" alt=\"\" data-cap=\"\" data-fig=\"FOFL.png\"></figure><p data-src=\"plate3.md:23-24\"><strong>Differentiable constraints → feedback-based constrained optimization.</strong><br>When constraints are explicitly known and differentiable, we can directly use their geometry. In <a href=\"https://arxiv.org/abs/2503.12665\" target=\"_blank\"><em>Constrained Optimization From a Control Perspective via Feedback Linearization</em></a>, we treat constraint violation as a dynamical quantity and design the optimization update to actively drive it toward zero. This yields convergence guarantees to KKT points and connects naturally to classical constrained optimization methods.</p><p data-src=\"plate3.md:27-27\">The same perspective extends to learning problems, including <a href=\"https://arxiv.org/abs/2605.08408\" target=\"_blank\"><em>AdamFLIP</em></a> for hard-constrained PINN training.</p><figure class=\"pfig\" data-fig=\"ZOFL.png\" data-src=\"plate3.md:29-29\"><img src=\"figs/key_figs/ZOFL.png\" alt=\"\" data-cap=\"\" data-fig=\"ZOFL.png\"></figure><p data-src=\"plate3.md:31-32\"><strong>Black-box constraints → zeroth-order constrained optimization.</strong><br>Sometimes we can evaluate a constraint but cannot differentiate it. My zeroth-order work asks how much of the same feasibility structure can still be recovered from function evaluations alone.</p><p data-src=\"plate3.md:34-34\"><a href=\"https://arxiv.org/abs/2509.24056\" target=\"_blank\"><em>Zeroth-Order Constrained Optimization via Feedback Linearization</em></a> extends the feedback-based approach to black-box constraints, while <a href=\"https://arxiv.org/abs/2604.02202\" target=\"_blank\"><em>Random-Subspace SQP</em></a> reduces evaluation cost by solving constrained updates in randomly sampled low-dimensional subspaces.</p>", "remains": "Both settings still assume that feasibility is explicitly defined. But in increasingly data-driven systems, we may only have examples of feasible behavior, with no constraint equation available at all.", "figs": []}, {"q": "How do we optimize when feasibility is represented only through data?", "kind": null, "qSrc": "plate3.md:40-40", "brief": "Our work on denoising-corrected gradient guidance views diffusion planning as constrained optimization with an implicitly learned feasible set.", "briefSrc": "plate3.md:42-42", "remainsSrc": null, "html": "<p data-src=\"plate3.md:43-43\">This is the setting I am studying in <strong>diffusion-based planning</strong>.</p><p data-src=\"plate3.md:45-45\">A diffusion model trained on feasible trajectories can generate plausible system behavior, but it does not provide an explicit description of the feasible trajectory set. At test time, we still want to optimize a new task objective without leaving that learned set.</p><figure class=\"pfig\" data-fig=\"gradient-guidance.png\" data-src=\"plate3.md:47-47\"><img src=\"figs/key_figs/gradient-guidance.png\" alt=\"\" data-cap=\"\" data-fig=\"gradient-guidance.png\"></figure><p data-src=\"plate3.md:49-49\">The challenge is that standard gradient guidance acts in the ambient trajectory space, so improving the task objective can simultaneously push the trajectory away from dynamically feasible behavior.</p><p data-src=\"plate3.md:52-52\"><strong>Approach:</strong> Our work on <strong>denoising-corrected gradient guidance</strong> views diffusion planning as constrained optimization with an implicitly learned feasible set. The gradient step improves the objective, while denoising acts as an approximate correction back toward feasible behavior.</p><div class=\"pfigpair\"><figure class=\"pfig\" data-fig=\"DCG-result.jpg\" data-src=\"plate3.md:54-54\"><img src=\"figs/key_figs/DCG-result.jpg\" alt=\"\" data-cap=\"\" data-fig=\"DCG-result.jpg\"></figure><figure class=\"pfig\" data-fig=\"DCG-result-2.jpg\" data-src=\"plate3.md:55-55\"><img src=\"figs/key_figs/DCG-result-2.jpg\" alt=\"\" data-cap=\"\" data-fig=\"DCG-result-2.jpg\"></figure></div><figure class=\"pfig\" data-fig=\"DCG-result-legend.jpg\" data-src=\"plate3.md:57-57\"><img src=\"figs/key_figs/DCG-result-legend.jpg\" alt=\"\" data-cap=\"\" data-fig=\"DCG-result-legend.jpg\"></figure><p data-src=\"plate3.md:59-59\">Across these projects, the progression is really about <strong>how much access we have to feasibility</strong>:</p><p data-src=\"plate3.md:62-64\"><strong>differentiable constraints → gradient access</strong><br><strong>black-box constraints → query access</strong><br><strong>learned feasible behavior → data only</strong></p>", "remains": null, "figs": []}]}];
  SRCS.forEach(SRC => {
